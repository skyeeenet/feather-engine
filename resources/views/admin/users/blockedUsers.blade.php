...
@section('breadcrumb')
    <nav aria-label="breadcrumb" class="roboto16lt">
        <ol class="breadcrumb breadcrumb-dot bg-color my-2">
            ...
            <li class="breadcrumb-item active" aria-current="page">Заблокированные Пользователи</li>
        </ol>
    </nav>
@endsection
@section('title', 'Заблокированные Пользователи')
@section('content')
    <form id="search" method="GET" class="m-0" action="{{ action('Admin\Users\UserController@indexBlocked') }}">
    ...
    <form action="{{route('admin.users.trash')}}" method="post">
        ...
        <div class="roboto16">
            ...
            <div class="mt-5 d-flex align-items-center justify-content-center justify-content-sm-start flex-wrap">
                ...
                <span class="users_text ml-3">Заблокированные Пользователи</span>
                <a href="{{route('admin.users.create')}}" class="btn btn-success mx-2 my-1"><i class="fa fa-plus-circle mr-1"></i>Добавить</a>
                <button type="submit" class="btn btn-danger mx-2 my-1"><i class="fa fa-trash-o  mr-1"></i>Удалить выбранное
                </button>

                <a href="{{route('admin.users.trash')}}" class="btn btn-light mx-2 my-1">В корзину</a>
            </div>
        </div>
            ...
            <div class="container-fluid">
                <div class="d-flex justify-content-between my-4 pt-4 flex-wrap mx-5">
                    ...
                    <div class="d-flex align-items-center roboto16">
                        ...
                        <input class="custom-input" type="text" name="search" size="25" form="search">
                    </div>
                </div>
                    ...
                    <table class="table">
                        ...
                        @foreach($users as $user)
                            <tr class="border-bottom">
                                ...
                                <td scope="col" class="p-2" align="center"><a href="{{route('admin.users.edit', $user->id)}}" class="text-danger">{{$user->login}}</a>
                                </td>
                                <td scope="col"></td>
