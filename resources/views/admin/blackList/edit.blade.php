...
@endsection
@section('title', 'Редактирование Черного списка')
...
@section('content')
    ...
    <div class="mt-5 d-flex align-items-center">
        ...
        <span class="users_text mx-3">Редактирование Черного списка</span>
    </div>
    <form method="post" class="mt-4" action="{{route('admin.blackList.update', $user->id)}}">
        @csrf
        <div class="row">
            <div class="col bg-white shadow roboto16lt form-color mx-3">
                <div class="my-3">
                    ...
                    <input required type="text" id="name" name="name" class="w-100 input_fields" value="{{$user->name}}">
                </div>
                ...
                <div class="my-3">
                    ...
                    <input required type="text" name="url" class="w-100 input_fields" value="{{$user->url}}">
                </div>
