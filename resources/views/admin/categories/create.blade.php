...
@section('content')
    ...
    <div class="mt-5 d-flex align-items-center">
        ...
        <span class="users_text mx-3">Создание Категории</span>
    </div>
    <form method="post" class="mt-4" action="{{route('admin.categories.store')}}">
        @csrf
        <div class="row">
            <div class="col bg-white shadow roboto16lt form-color mx-3">
                ...
                <div class="my-3">
                    ...
                    <input required type="text" id="name" name="name_ua" class="w-100 input_fields" value="">
                </div>
                ...
                <div class="my-3">
                    ...
                    <input required id="slug" type="text" name="slug" class="w-100 input_fields" placeholder="">
                </div>
                ...
                <div class="my-3">
                    ...
                    <input required type="text" name="sort" value="1" class="w-100 input_fields" placeholder="">
                </div>
