@section('breadcrumb')
    <nav aria-label="breadcrumb" class="roboto16lt">
        <ol class="breadcrumb breadcrumb-dot bg-color my-2">
            ...
            <li class="breadcrumb-item active" aria-current="page">Создание языка</li>
        </ol>
    </nav>
@endsection
...
@section('content')
    ...
    <div class="mt-5 d-flex align-items-center">
        ...
        <span class="users_text mx-3">Создание Языка</span>
    </div>
    <form method="post" class="mt-4" action="{{route('admin.languages.store')}}">
        @csrf
        <div class="row">
            <div class="col bg-white shadow roboto16lt form-color mx-3">
                <div class="my-3">
                    @include('admin.includes.fields.input', ['label_name' => 'Ключевое значение', 'required' => true, 'type' => 'text', 'name' => 'key'])
                </div>
