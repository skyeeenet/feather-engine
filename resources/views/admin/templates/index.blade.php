@section('breadcrumb')
    <nav aria-label="breadcrumb" class="roboto16lt">
        <ol class="breadcrumb breadcrumb-dot bg-color my-2">
            ...
            <li class="breadcrumb-item active" aria-current="page">Шаблоны</li>
        </ol>
    </nav>
@endsection
...
@section('content')
    ...
    <div class="roboto16">
        ...
        <div class="mt-5 d-flex align-items-center justify-content-center justify-content-sm-start flex-wrap">
            <i class="fas fa-palette fa-4x ml-2 ml-sm-0"></i>
            <span class="users_text mx-3">Шаблоны</span>
            <a href="{{route('admin.templates.create')}}" class="btn btn-success mx-2 my-1"><i class="fa fa-plus-circle mr-1"></i>Добавить</a>
        </div>
    </div>
    <div class="bg-white shadow d-block mb-5 roboto14">
        ...
        <div class="table-responsive-xl">
            <table class="table">
                ...
                <tr class="border-bottom">
                    <th scope="col" class="pt-2 pl-2 pb-2 pr-0 text-center"><a class="sort" href="#">Название шаблона</a></th>
                    <th scope="col" class="pt-2 pr-0 pb-2 pl-2 text-center"><a class="sort" href="#">Путь к шаблону</a></th>
                ...
                @foreach($templates as $item)
                    <tr class="border-bottom">
                        ...
                        <td scope="col" class="p-2" align="center">{{$item->path}}</td>
                        <td scope="col" class="p-2">
                            <div class=" d-flex flex-column align-items-center">
                              <form action="{{route('admin.templates.destroy', $item->id)}}" method="post">
                                ...
                                <a href="{{route('admin.templates.edit', $item->id)}}" class="btn btn-primary my-1"><div class="d-flex align-items-center"><i class="fa fa-edit mr-1"></i>Изменить
                                    </div></a>
                            </div>
                        </td>
                    </tr>
        ...
        <div class="mt-4 d-flex justify-content-sm-between justify-content-center pb-5 mx-2 flex-wrap">
            <div class="d-flex align-items-center mb-2">
                <span>Показано от 1 до {{$templates->count()}} из {{$templates->total()}} записей</span>
            </div>
            {{$templates->links()}}
        </div>
    </div>
