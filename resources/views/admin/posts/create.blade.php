        ...
        <div class="row">
            <div class="col bg-white shadow roboto16lt form-color mx-3">
                ...
                <div class="my-3">
                    ...
                    <input type="file" name="image" class="w-100 input_fields" value="">
                </div>
                <div class="my-3">
                    <label for="name" class="d-block">
                        Seo Url
                ...
                <div class="my-3">
                    ...
                    <input required type="text" id="slug" name="seo_title" value="" class="w-100 input_fields" placeholder="">
                </div>
                <div class="my-3">
                    <label for="name" class="d-block">
                        Seo Description
                ...
                <div class="my-3">
                    ...
                    <textarea class="form-control" name="short" id="" cols="30" rows="10"></textarea>
                </div>
