...
@section('content')
    ...
    <div class="roboto16">
        ...
        <div class="mt-5 d-flex align-items-center justify-content-center justify-content-sm-start flex-wrap">
            ...
            <span class="users_text mx-3">Записи</span>
            <a href="{{route('admin.posts.create')}}" class="btn btn-success mx-2 my-1"><i class="fa fa-plus-circle mr-1"></i>Добавить</a>
        </div>
    </div>
    <div class="bg-white shadow d-block mb-5 roboto14">
        ...
        <div class="table-responsive-xl">
            <table class="table">
                ...
                <tr class="border-bottom">
                    ...
                    <th scope="col" class="pt-2 pl-2 pb-2 pr-0 text-center"><a class="sort" href="#">Статус</a></th>
                    <th scope="col" class="pt-2 pl-2 pb-2 pr-0 text-center"><a class="sort" href="#">Название</a></th>
                    <th scope="col" class="pt-2 pl-2 pb-2 pr-0 text-center"><a class="sort" href="#">Seo Title</a></th>
                    <th scope="col" class="pt-2 pr-0 pb-2 pl-2 text-center"><a class="sort" href="#">Seo H1</a></th>
                    <th scope="col" class="pt-2 pr-0 pb-2 pl-2 text-center"><a class="sort" href="#">Автор</a></th>
                ...
                @foreach($posts as $item)
                    <tr class="border-bottom">
                        ...
                        <td scope="col" class="p-2" align="center">{{$item->seo_title}}</td>
                        <td scope="col" class="p-2" align="center">{{$item->seo_h1}}</td>
                        <td scope="col" class="p-2" align="center"><a href="{{route('admin.users', $item->user['id'])}}">{{$item->user['email']}}</a></td>
                        <td scope="col" class="p-2">
                            <div class=" d-flex flex-column align-items-center">
                              <form action="{{route('admin.posts.destroy', $item->id)}}" method="post">
                                ...
                                <a href="{{route('admin.posts.edit', $item->id)}}" class="btn btn-primary my-1"><div class="d-flex align-items-center"><i class="fa fa-edit mr-1"></i>Изменить
                                    </div></a>
                            </div>
                        </td>
                    </tr>
        ...
        <div class="mt-4 d-flex justify-content-sm-between justify-content-center pb-5 mx-2 flex-wrap">
            <div class="d-flex align-items-center mb-2">
                <span>Показано от 1 до {{$posts->count()}} из {{$posts->total()}} записей</span>
            </div>
            {{$posts->links()}}
        </div>
    </div>
